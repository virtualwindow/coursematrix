...
var coursedata = {
  ...
  fieldstext : [
    ...
    //short courses
     ...
     {outcome:1,school:1,field:6,name:"Screenwriting Methods for Short Animations", description:"Ever had an idea too magical to be captured in a live action short film? Are your stories best told by claymation, traditional animation or 3D animation? Every film has its challenges, in this course the learner will learn the skills and techniques required to face the unique and exciting challenges of writing an animated short film."},          
     {outcome:1,school:1,field:7,name:"Sound Design in Pro Tools", description:"Pro Tools is the industry standard in Audio Post Production throughout the world of film, this course provides the learner with the skills to work within Pro Tools and be a effective operator for Sound Design in Digital Media."},
     {outcome:1,school:1,field:7,name:"Studio and Location Sound Recording", description:"Every sound in a digital media is captured to generate a world for you to experience, in this course  learners will learn how to record sound inside a professional studio and outside on location, all to enhance the experience of their digital media."},
     {outcome:1,school:1,field:7,name:"Sound for Games", description:"A game takes you into a world you want to experience, gives you a thrill and excitement you looking to experience. Sound within games is important in recreating the experience. In this course the learner a will learn how to interface Pro Tools with Unity and create a sound-stage and effects for their games."},         
     
     {outcome:1,school:2,field:0,name:"Responsive Web: Website Planning & Workflow", description:"Learn to plan websites that will respond to and correctly display on a variety of digital devices that access your website. Understand the workflow, processes and deliverables required in planning, design and implementing a Web project."},
     {outcome:1,school:2,field:0,name:"Website Design", description:"This course will equip you with the essential knowledge and skills to create visual designs for responsive websites. Learn to apply fundamental design elements and principles in the digital Web environment."},
     {outcome:1,school:2,field:0,name:"Website Implementation", description:"Convert visual website designs into working HTML Web pages using Adobe web-export tools and Adobe Dreamweaver. Gain fundamental skills to structure Web pages using HTML and CSS, while being introduced to other Web technologies used to make websites dynamic and interactive."},
     {outcome:1,school:2,field:0,name:"Adobe Muse", description:"Adobe Muse is aimed at graphic designers, allowing them to publish dynamic websites for desktop and mobile devices without writing code. Adding interactivity is made easy through a range of existing components and widgets."},
     {outcome:1,school:2,field:0,name:"WordPress Theme Design", description:"Learn to style and customize WordPress Themes using a range of methods, including Page Templates. Using Page Templates requires little to no Web development knowledge and allows you to create custom pages within a WordPress theme."},
     {outcome:1,school:2,field:0,name:"User Interface (UI) and Screen Design", description:"Designing for screen and the “user interface” is a daunting task. The large variety of digital devices and features they offer present many challenges for digital design. This course will equip you with a fundamental understanding and skillset to successfully solve these challenges. "},
     {outcome:1,school:2,field:0,name:"Mobile Application Design", description:"Create visual designs for a (native) mobile application that adhere to manufacturer’s (Apple iOS) standards and best practice guidelines. Present your screen designs and a user-flow diagram that illustrate interaction and page transitions."},
     {outcome:1,school:2,field:0,name:"Prototyping: Interactive Media", description:"Presenting your interactive applications to clients or team members, i.e. development team, communicate best when interaction and other dynamic features are simulated in the presentation. Creating these interactive presentations/simulations are referred to as (digital) prototyping."},
     {outcome:1,school:2,field:1,name:"HTML5 & CSS3", description:"HTML5 is the latest version of the technology that provides the underlying structure of Web pages. Visual display of HTML pages is controlled with CSS3, which allows us to create a rich (aesthetic) experience with HTML Web pages."},
     {outcome:1,school:2,field:1,name:"JavaScript", description:"JavaScript is the most popular client-side scripting language that provides the capability to manipulate Web pages through the interface or Web browser. Provide users with a dynamic Web experience and ad interactive features to your website."},
     {outcome:1,school:2,field:1,name:"jQuery", description:"jQuery is the most popular JavaScript library, which allows you to ad dynamic features such as document manipulation and animation to your website with great ease. This feature-rich cross-platform library has changed the way many developers write JavaScript."},
     {outcome:1,school:2,field:1,name:"Mobile Web: jQuery Mobile", description:"jQuery Mobile is a HTML5-based user interface system designed to make responsive web sites and apps that are accessible on all smartphone, tablet and desktop devices."},
     {outcome:1,school:2,field:1,name:"PHP & MySQL 101", description:"Create database-driven websites using the most popular server-side technologies. Use PHP to separate your websites design, structure and functionality from it’s content by serving dynamic pages from the server, which loads content your from the MySQL database."},
     {outcome:1,school:2,field:1,name:"PHP & MySQL 102", description:"Learn to write Object Oriented (OO) PHP programs and build upon your PHP & MySQL skills by exploring advanced server-side and Web development topics and methodologies. Apply your new skills and develop a sophisticated Web application."},
     {outcome:1,school:2,field:1,name:"CMS: WordPress", description:"Unleash the power of the most popular Content Management System (CMS) WordPress to create unique designs and functionality for your clients. Learn to develop custom WordPress Themes that suit your clients needs and allow them to instantly change the look of their website."},
     {outcome:1,school:2,field:1,name:"CMS: Joomla", description:"Discover the true power of Joomla, the most popular Content Management System (CMS) amongst Web developers, to create unique designs and functionality for your clients. Learn to develop custom Joomla Themes that suit your clients needs and allow them to instantly change the look of their website. "},
     {outcome:1,school:2,field:1,name:"Web Application Development", description:"Web applications are becoming increasingly more popular due their cross-platform nature, and ability to be updated and maintained, and no need for distribution and installation. This course equips you with the skills to develop software applications that run in the Web environment."},
     {outcome:1,school:2,field:2,name:"Adobe Dreamweaver", description:"Learn to use Dreamweaver’s intuitive visual interface to create and edit websites and publish to Web and mobile platforms. This course focus on software training and the essential features required for web and mobile authoring."},
     {outcome:1,school:2,field:2,name:"Actionscript 3.0", description:"Learn to develop interactive multimedia projects using the native programming language for Adobe Flash. Actionscript 3.0 is also used to develop cross-platform Web applications and Rich Internet Applications (RIA) that runs natively on desktop computers using Apache Flex."},
     {outcome:1,school:2,field:2,name:"Java Fundamentals", description:"Learn to use the core Java Programming Language, one of the most popular and robust programming languages, using Java ME (Micro Edition). Java is used in many development environments including web and mobile devices."},
     {outcome:1,school:2,field:2,name:"Objective-C Language Fundamentals", description:"Objective-C is a general-purpose, object-oriented programming language and the main programming language for Apple’s OS X and iOS. This course focus on Objective-C language fundamentals and serves as an introduction to iOS mobile app development."},
     {outcome:1,school:2,field:2,name:"Hybrid Mobile Application Development 1", description:"Develop mobile applications (Apps) using Web technologies such as HTML5. Hybrid apps are becoming increasingly popular and hold many advantages, depending on your mobile strategy."},
     {outcome:1,school:2,field:2,name:"Hybrid Mobile Application Development 2", description:"Build on your existing knowledge of hybrid app development and learn to add advanced features to your mobile apps. You will also explore packaging and distributing your app in this module."},
     {outcome:1,school:2,field:2,name:"iOS Application Development 1", description:"Developing apps for iOS requires the use of a specific development tool xCode and programming language Objective-C. This course serves as an introduction to the iOS development workflow and tools."},
     {outcome:1,school:2,field:2,name:"iOS Application Development 2", description:"Learn to use xCode, Objective-C and the Cocoa Touch API to develop a native iOS app. Build an app that conforms to standards set out by Apple’s guidelines."},
