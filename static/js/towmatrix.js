...
courselist: [
    ...
    // set pscHide to 1 to hide from professional skills lists
     ...
     {outcome:3,pscHide:1,school:1,field:5,compulsory:2,name:"Screen Acting ", description:"Not currently available in Professional Skills Course format."},
     {outcome:3,pscHide:1,school:1,field:5,compulsory:2,name:"Screen Acting ", description:"Not currently available in Professional Skills Course format."},
     {outcome:3,pscHide:1,school:1,field:5,compulsory:2,name:"Screen Acting ", description:"Not currently available in Professional Skills Course format."},
     {outcome:3,pscHide:1,school:1,field:5,compulsory:2,name:"Screen Acting ", description:"Not currently available in Professional Skills Course format."},
     {outcome:3,pscHide:1,school:1,field:5,compulsory:2,name:"Screen Acting ", description:"Not currently available in Professional Skills Course format."},
    ...
    carreers: [
      {school: 0, name: "Storyboard Illustrators", description: " Visualise and illustrate important moments in the narrative of a TV commercial or film production."},
      {school: 0, name: "Editorial Photographers", description: " Commercial freelance photographers deliver work for magazine publishing, ranging from food-, architecture-, portrait-, fashion-, beauty-, automotive- and travel photography, depending on the nature and target market of the magazine."},
      {school: 0, name: "Professional Image Retouchers", description: " Are responsible for the post-production of photographic images for both print and digital media (magazines, web-based, large scale advertisements, etc), ranging from basic corrective to advanced manipulative editing."},
      {school: 0, name: "Graphic Designers", description: " Are responsible for the creation of the visual representation of a company, brand or campaign’s identity. This includes the design of logos, corporate identities and accompanying stationery. Graphic Designers are also involved in layout, photo manipulation and the creation of advertisements."},
      {school: 0, name: "Editorial Designers", description: " Are responsible for the layout of images and text of magazines, newspapers, websites, mobile devices and other formats. It involves the placement of elements in a manner which displays artistic flair and emulates the basic principles of the publication."},
      {school: 0, name: "Packaging Designers", description: " Specialise in the design of packaging material for a variety of products in both a functional and aesthetically pleasing manner."},
      {school: 0, name: "Advertising Executives", description: " Combine creativity with sound business practice to market a product through the management of client accounts. The success of a marketing campaign relies on the integration between the financial, sociological and psychological considerations of a project."},
      {school: 1, name: "Film / Television Director", description: " Creates and oversees the creation of audio-visual content for the big screen and for television. This ranges from feature films, to television magazine inserts, to TV series, to educational programmes."},
      {school: 1, name: "Technical Director", description: " Oversees and advises the film crew when creating audio-visual content for specialised post-production purposes such as compositing and special-effects."},
      {school: 1, name: "Film / Television Editor", description: " Edits and supervises post-production audio-visual content for film and television."},
      {school: 1, name: "Documentary Filmmaker", description: " Captures and assembles incisive material based on real life situations/conditions."},
      {school: 1, name: "Scriptwriter", description: " Conceives and writes original material for the big screen and television. The better a scriptwriter understands the full filmmaking process, the better their scripts."},
      {school: 1, name: "Advertising Director", description: " Conceptualises and realises audio-visual advertising campaigns."},
      {school: 1, name: "Corporate Filmmaker", description: " Conceptualises and realises audio-visual content relevant to the needs of corporate businesses."},
      {school: 1, name: "Sound designer for Film & Television", description: " Designs and assembles all the audio components of an audio-visual project from music to voice-overs and completes the final mix. (You do not need to be a musician to do this.)"},
      {school: 1, name: "Audio-visual Artist", description: " Creates conceptual artworks using aspects of the audio-visual media for fine art or corporate exhibition purposes."},
      {school: 1, name: "Storyboard Artist", description: " Creating a visual representation of a proposed audio-visual project that captures the vision of the director."},
      {school: 1, name: "Motion Graphics Designer", description: " Animating computer based audio-visual content for entertainment, corporate or educational purposes. Usually the design of title sequences for feature films and TV programmes, and the visualization of hard information to make it more accessible to an audience."},
      {school: 1, name: "Stop-motion Animator", description: " Animating frame by frame to create the illusion of movement. This can be done using anything from paper cut-outs, to clay, to objects, to puppets. Can be applied to entertainment, music videos and advertising."},
      {school: 1, name: "Cell Animator", description: " Hand-drawn animation in the old tradition of animating directly onto cell/paper. This is incorporated with digital technology to make the workflow easier. Can be applied to entertainment, music videos and advertising."},
      {school: 1, name: "3D Animator", description: " Creates digital animations using specialised 3D software.  Productions range from corporate, advertising to entertainment media."},
      {school: 1, name: "Character Animator", description: " Similar to a 3D Animator, but with specific focus on narrative/performance based animations. Character animators often work as part of a larger production team comprised of other 3D specialists."},
      {school: 1, name: "Concept Artist", description: " Concerned with creating the look and feel for digital productions. They are often keen illustrators or digital sculptors that develop ideas into visuals for films, video games, animation or comic books."},
      {school: 1, name: "Layout Artist", description: " Takes direction from storyboard artists and directors to create virtual environments while incorporating both 2D & 3D skills. Layout artists will often work within a team of 3D artists on large productions."},
      {school: 1, name: "3D Specialist", description: " Specialists form part of a larger production team. Disciplines like 3D modeling, texturing, lighting, rigging and rendering, to name a few, are all areas of specialization within 3D Animation. A 3D Generalist is someone skilled in all aspects of the production pipeline."},
      {school: 1, name: "3D Visualiser", description: " Creates presentations for various industries such as Product Design & Manufacturing, Architecture, Military, Mining or Medical industries. These presentations could also include interactive virtual simulations."},
      {school: 1, name: "Game Designer", description: " Creates the visual elements of a game, such as characters, environments, game objects and user interface components. Game Designers start by developing concept art and game ideas into a playable prototype that looks and feels like an actual game.  Typically the next phase of the game production would require the input of a Game Developer or additional programming skills."},
      {school: 1, name: "Compositor", description: " Edits and composites multi-layered audio-visual content for digitally enhanced film and television productions."},
      {school: 1, name: "Special Effects Artist", description: " Generates special effects for digitally enhanced film and television productions.  Special effects artists will often work closely with compositors and animators to achieve the optimum results for large productions."},
      {school: 2, name: "Interactive Designers", description: " Are critical thinkers with a good design sense, who create the overall look and feel of a wide range of interactive communication products."},
      {school: 2, name: "User Experience Designers", description: " Are critical thinkers with a good design sense who design solutions to improve how people interact with websites and products with the goal of creating an optimal user experience."},
      {school: 2, name: "Interaction Designers", description: " Are critical thinkers who design the structure of behaviour for human interaction with software and products to facilitate better human/user experience."},
      {school: 2, name: "Mobile Application Designers", description: " Are critical thinkers with a good design sense and strong technical background who design systems and interfaces for mobile applications."},
      {school: 2, name: "User Interface Designers", description: " Have a good design sense and strong technical background and are responsible for designing interfaces for a variety of applications, such as websites, computer programmes and applications for smart devices."},
      {school: 2, name: "Retail Designers", description: " Create 3D designs in stores to capture the customers’ eye and promote products and services."},
      {school: 2, name: "Product Designers", description: " Design most things we use in our day-to-day lives, from chairs and cutlery to clocks and computers, with the aim to improve the way existing products work and look."},
      {school: 2, name: "Packaging Designers", description: " Design cost-effective packaging for products or goods from conception to completion, which includes testing prototypes and materials."},
