...
var coursedata = {
  ...
  fieldstext : [
    ...
    //short courses
     ...
     {outcome:1,school:1,field:6,slp:18,name:"Screenwriting Methods for Short Animations", description:"Ever had an idea too magical to be captured in a live action short film? Are your stories best told by claymation, traditional animation or 3D animation? Every film has its challenges, in this course the learner will learn the skills and techniques required to face the unique and exciting challenges of writing an animated short film."},          
     {outcome:1,school:1,field:7,slp:19,name:"Sound Design in Pro Tools", description:"Pro Tools is the industry standard in Audio Post Production throughout the world of film, this course provides the learner with the skills to work within Pro Tools and be a effective operator for Sound Design in Digital Media."},
     {outcome:1,school:1,field:7,slp:19,name:"Studio and Location Sound Recording", description:"Every sound in a digital media is captured to generate a world for you to experience, in this course  learners will learn how to record sound inside a professional studio and outside on location, all to enhance the experience of their digital media."},
     {outcome:1,school:1,field:7,slp:19,name:"Sound for Games", description:"A game takes you into a world you want to experience, gives you a thrill and excitement you looking to experience. Sound within games is important in recreating the experience. In this course the learner a will learn how to interface Pro Tools with Unity and create a sound-stage and effects for their games."},         
     
     {outcome:1,school:2,field:0,slp:20,name:"Responsive Web: Website Planning & Workflow", description:"Learn to plan websites that will respond to and correctly display on a variety of digital devices that access your website. Understand the workflow, processes and deliverables required in planning, design and implementing a Web project."},
     {outcome:1,school:2,field:0,slp:21,name:"Website Design", description:"This course will equip you with the essential knowledge and skills to create visual designs for responsive websites. Learn to apply fundamental design elements and principles in the digital Web environment."},
     {outcome:1,school:2,field:0,slp:21,name:"Website Implementation", description:"Convert visual website designs into working HTML Web pages using Adobe web-export tools and Adobe Dreamweaver. Gain fundamental skills to structure Web pages using HTML and CSS, while being introduced to other Web technologies used to make websites dynamic and interactive."},
     {outcome:1,school:2,field:0,slp:21,name:"Adobe Muse", description:"Adobe Muse is aimed at graphic designers, allowing them to publish dynamic websites for desktop and mobile devices without writing code. Adding interactivity is made easy through a range of existing components and widgets."},
     {outcome:1,school:2,field:0,slp:22,name:"WordPress Theme Design", description:"Learn to style and customize WordPress Themes using a range of methods, including Page Templates. Using Page Templates requires little to no Web development knowledge and allows you to create custom pages within a WordPress theme."},
     {outcome:1,school:2,field:0,slp:22,name:"User Interface (UI) and Screen Design", description:"Designing for screen and the “user interface” is a daunting task. The large variety of digital devices and features they offer present many challenges for digital design. This course will equip you with a fundamental understanding and skillset to successfully solve these challenges. "},
     {outcome:1,school:2,field:0,slp:22,name:"Mobile Application Design", description:"Create visual designs for a (native) mobile application that adhere to manufacturer’s (Apple iOS) standards and best practice guidelines. Present your screen designs and a user-flow diagram that illustrate interaction and page transitions."},
     {outcome:1,school:2,field:0,slp:23,name:"Prototyping: Interactive Media", description:"Presenting your interactive applications to clients or team members, i.e. development team, communicate best when interaction and other dynamic features are simulated in the presentation. Creating these interactive presentations/simulations are referred to as (digital) prototyping."},
     {outcome:1,school:2,field:1,slp:24,name:"HTML5 & CSS3", description:"HTML5 is the latest version of the technology that provides the underlying structure of Web pages. Visual display of HTML pages is controlled with CSS3, which allows us to create a rich (aesthetic) experience with HTML Web pages."},
     {outcome:1,school:2,field:1,slp:24,name:"JavaScript", description:"JavaScript is the most popular client-side scripting language that provides the capability to manipulate Web pages through the interface or Web browser. Provide users with a dynamic Web experience and ad interactive features to your website."},
     {outcome:1,school:2,field:1,slp:24,name:"jQuery", description:"jQuery is the most popular JavaScript library, which allows you to ad dynamic features such as document manipulation and animation to your website with great ease. This feature-rich cross-platform library has changed the way many developers write JavaScript."},
     {outcome:1,school:2,field:1,slp:24,name:"Mobile Web: jQuery Mobile", description:"jQuery Mobile is a HTML5-based user interface system designed to make responsive web sites and apps that are accessible on all smartphone, tablet and desktop devices."},
     {outcome:1,school:2,field:1,slp:25,name:"PHP & MySQL 101", description:"Create database-driven websites using the most popular server-side technologies. Use PHP to separate your websites design, structure and functionality from it’s content by serving dynamic pages from the server, which loads content your from the MySQL database."},
     {outcome:1,school:2,field:1,slp:25,name:"PHP & MySQL 102", description:"Learn to write Object Oriented (OO) PHP programs and build upon your PHP & MySQL skills by exploring advanced server-side and Web development topics and methodologies. Apply your new skills and develop a sophisticated Web application."},
     {outcome:1,school:2,field:1,slp:25,name:"CMS: WordPress", description:"Unleash the power of the most popular Content Management System (CMS) WordPress to create unique designs and functionality for your clients. Learn to develop custom WordPress Themes that suit your clients needs and allow them to instantly change the look of their website."},
     {outcome:1,school:2,field:1,slp:25,name:"CMS: Joomla", description:"Discover the true power of Joomla, the most popular Content Management System (CMS) amongst Web developers, to create unique designs and functionality for your clients. Learn to develop custom Joomla Themes that suit your clients needs and allow them to instantly change the look of their website. "},
     {outcome:1,school:2,field:1,slp:24,name:"Web Application Development", description:"Web applications are becoming increasingly more popular due their cross-platform nature, and ability to be updated and maintained, and no need for distribution and installation. This course equips you with the skills to develop software applications that run in the Web environment."},
     {outcome:1,school:2,field:2,slp:24,name:"Adobe Dreamweaver", description:"Learn to use Dreamweaver’s intuitive visual interface to create and edit websites and publish to Web and mobile platforms. This course focus on software training and the essential features required for web and mobile authoring."},
     {outcome:1,school:2,field:2,slp:24,name:"Actionscript 3.0", description:"Learn to develop interactive multimedia projects using the native programming language for Adobe Flash. Actionscript 3.0 is also used to develop cross-platform Web applications and Rich Internet Applications (RIA) that runs natively on desktop computers using Apache Flex."},
     {outcome:1,school:2,field:2,slp:25,name:"Java Fundamentals", description:"Learn to use the core Java Programming Language, one of the most popular and robust programming languages, using Java ME (Micro Edition). Java is used in many development environments including web and mobile devices."},
     {outcome:1,school:2,field:2,slp:25,name:"Objective-C Language Fundamentals", description:"Objective-C is a general-purpose, object-oriented programming language and the main programming language for Apple’s OS X and iOS. This course focus on Objective-C language fundamentals and serves as an introduction to iOS mobile app development."},
     {outcome:1,school:2,field:2,slp:23,name:"Hybrid Mobile Application Development 1", description:"Develop mobile applications (Apps) using Web technologies such as HTML5. Hybrid apps are becoming increasingly popular and hold many advantages, depending on your mobile strategy."},
     {outcome:1,school:2,field:2,slp:23,name:"Hybrid Mobile Application Development 2", description:"Build on your existing knowledge of hybrid app development and learn to add advanced features to your mobile apps. You will also explore packaging and distributing your app in this module."},
     {outcome:1,school:2,field:2,slp:21,name:"iOS Application Development 1", description:"Developing apps for iOS requires the use of a specific development tool xCode and programming language Objective-C. This course serves as an introduction to the iOS development workflow and tools."},
     {outcome:1,school:2,field:2,slp:21,name:"iOS Application Development 2", description:"Learn to use xCode, Objective-C and the Cocoa Touch API to develop a native iOS app. Build an app that conforms to standards set out by Apple’s guidelines."},
    ...
    //SLPs 
     ...
     {outcome:2,school:0,field:2,slp:6,name:"Photography Techniques (Basic – Intermediate)", description:"This short-learning programme introduces the learner to the fundamental principles, theories and techniques required to practice digital photography, comprising the development of an awareness of light; the ability to control and modify light in order to creatively model lighting on subject matter; the ability to interpret light meter readings accurately in order to refine exposure control; and, to use Adobe Photoshop in order to skillfully apply appropriate post-production to captured digital images."},
     {outcome:2,school:0,field:2,slp:7,name:"Photography Techniques (Advanced)", description:"This short-learning programme broadens the learner’s skill sets, complementing the student’s fundamental photography tools and techniques with the development of creativity, artistic sensitivity and visionary ability.  This programme introduces the student to the use of daylight-balanced flash used in mixed lighting conditions, advanced Adobe Photoshop and post-production skills."}, 
     ...
     {outcome:2,school:1,field:0,slp:9,name:"Animation & VFX", description:"Animation & Visual Effects introduces students to the essential skills used in contemporary motion graphics. Students are guided through a range of animation techniques and styles  - from with basic shape, text and image animation to combining 3D and 2D elements, also compositing motion graphics into live-action footage and traditional stop-motion animation. Emphasis is placed on gaining thorough practical knowledge and developing animation ability through a solid understanding, and the effective consideration, of animation principles when producing professional motion graphics."},
     {outcome:2,school:1,field:0,slp:10,name:"3D Animation Kick-starter", description:"The 3D Animation Kick-starter course is aimed at providing the essential skills and techniques required to allow students to create their own animated short films. Students with no prior animation experience can create characters, build new worlds, and tell stories limited only by their imaginations. The course provides students with a foundation understanding of working in 3D applications, and guides them through the entire 3D character animation production pipeline from modeling, texturing and rigging to animation, lighting and rendering. Students are also introduced to principles and methods of screenwriting geared toward the short animation format."},
     {outcome:2,school:1,field:1,slp:11,name:"Foundation in Digital Filmmaking", description:"The Film-making foundational course is designed specifically to provide aspiring filmmakers with little or no film-making experience with the practical skills necessary to realize their filmic vision. Students are equipped with skills necessary to develop their own craft and become valuable assets to the film industry in South Africa. This short learning program comprises four sections throughout which students will be exposed to the basic skills associated with film production including basic DSLR camerawork, sound recording, lighting and filming. Students are also provided with a foundational framework of film conventions and narrative devices. Furthermore, students will receive a basic overview of film editing and the post-production process. Having completed the Film-making foundational Short Learning Program, students will have been  introduced to the skills necessary to film, edit and craft short film projects and also acquire an understanding of the processes involved in the film-making environment."},
     {outcome:2,school:1,field:1,slp:12,name:"Writing and Directing Digital Media", description:"This SLP is geared toward preparing students to function within the film and television industry. Students are guided through the process of developing an understanding of the process involved in producing and initiating a film project. Through the course, students will acquire a deeper understanding of initiating a film, gathering support and funding, putting together a crew, location scouting, creating a pre-production package and shooting script and identifying distribution avenues and film festivals. Students are further equipped with necessary cinematography and screenwriting skills and the basic concepts of production design for film and advertising."},
     {outcome:2,school:1,field:2,slp:13,name:"Make Games", description:"The Make Games SLP equips students to create, design and develop their own functional, interactive games. To introduce the student to the art of game design, the professional practice from an industry perspective, as well as software training in Unity3D. Students will be making game prototypes, while practicing essential game design processes and techniques. The students are introduced to fundamental concepts and core language structures of game programming. The purpose of the course is to facilitate game functionality in terms of saving player profiles, scoring systems, leader-boards and loading data. The course includes a survey of commercial languages, as well as proprietary scripting languages from industry applications. Further, we introduce you to making interactive circuits. You will learn how to control lights and/or motors and measure the world through sensors. You will learn fundamentals of programming devices and building electronic circuits in a practical and visual way. And finally we introduce you to coding with javascript and generating interactive 3D scenes in the browser with three.js. You will learn the fundamentals of programming while having fun generating art with numbers."},
     {outcome:2,school:1,field:3,slp:14,name:"Animation & VFX", description:"Animation & Visual Effects introduces students to the essential skills used in contemporary motion graphics. Students are guided through a range of animation techniques and styles  - from with basic shape, text and image animation to combining 3D and 2D elements, also compositing motion graphics into live-action footage and traditional stop-motion animation. Emphasis is placed on gaining thorough practical knowledge and developing animation ability through a solid understanding, and the effective consideration, of animation principles when producing professional motion graphics."},
     {outcome:2,school:1,field:4,slp:15,name:"Writing and Directing Digital Media", description:"This SLP is geared toward preparing students to function within the film and television industry. Students are guided through the process of developing an understanding of the process involved in producing and initiating a film project. Through the course, students will acquire a deeper understanding of initiating a film, gathering support and funding, putting together a crew, location scouting, creating a pre-production package and shooting script and identifying distribution avenues and film festivals. Students are further equipped with necessary cinematography and screenwriting skills and the basic concepts of production design for film and advertising."},
     {outcome:2,school:1,field:5,slp:16,name:"Screen Acting not available", description:"Screen Acting does not currently feature within the Short Course offering."},
     {outcome:2,school:1,field:6,slp:17,name:"3D Animation Kick-starter", description:"The 3D Animation Kick-starter course is aimed at providing the essential skills and techniques required to allow students to create their own animated short films. Students with no prior animation experience can create characters, build new worlds, and tell stories limited only by their imaginations. The course provides students with a foundation understanding of working in 3D applications, and guides them through the entire 3D character animation production pipeline from modeling, texturing and rigging to animation, lighting and rendering. Students are also introduced to principles and methods of screenwriting geared toward the short animation format."},
     {outcome:2,school:1,field:6,slp:18,name:"Writing and Directing Digital Media", description:"This SLP is geared toward preparing students to function within the film and television industry. Students are guided through the process of developing an understanding of the process involved in producing and initiating a film project. Through the course, students will acquire a deeper understanding of initiating a film, gathering support and funding, putting together a crew, location scouting, creating a pre-production package and shooting script and identifying distribution avenues and film festivals. Students are further equipped with necessary cinematography and screenwriting skills and the basic concepts of production design for film and advertising."},
     {outcome:2,school:1,field:7,slp:19,name:"Sound Design Techniques", description:"Pro Tools is the industry standard in Audio Post Production throughout the world of film, this course provides the learner with the skills to work within Pro Tools and be a effective operator for Sound Design in Digital Media. Additionally, students learn how to record sound inside a professional studio and outside on location, all to enhance the experience of their digital media and produce effective audio content for games."},
     
     {outcome:2,school:2,field:0,slp:20,name:"Responsive Website Design", description:"Learn to plan for and design Web content that can be served to a range of devices, from desktop computers to tablets and mobile devices. Control how Web content responds to the variations in screen sizes and device capabilities."},
     {outcome:2,school:2,field:0,slp:21,name:"Web & Mobile Design Technologies", description:"Learn to implement visual website designs in HTML format and WordPress, the leading Content Management System (CMS). Use the popular JavaScript library jQuery Mobile to create mobile websites that are “touch-friendly”."},
     {outcome:2,school:2,field:0,slp:22,name:"Design for Small Screens", description:"Understand the fundamentals of designing for a variety of digital devices. This course will provide you with the essential skills to design successful user interfaces (UI) and mobile applications (iOS). Learn to present your projects to clients or development teams using interactive prototypes."},
     {outcome:2,school:2,field:1,slp:23,name:"Accessible Website Implementation", description:"Implement website designs in HTML format that adhere to accessibility standards. Learn to use the rich set of features and unleash the power of HTML5 and CSS3."},
     {outcome:2,school:2,field:1,slp:24,name:"Client-Side Scripting", description:"Take your websites to the next level and provide users with a rich interactive Web and mobile Web experience using the most popular client-side scripting technologies: JavaScript, jQuery and jQuery Mobile."},
     {outcome:2,school:2,field:1,slp:25,name:"Server-Side Scripting", description:"Develop powerful database-driven websites and Web applications using the most popular Open Source technologies PHP & MySQL. Choose one of the two most popular Content Management Systems (CMS) WordPress or Joomla to develop dynamic websites that are easy to mange and maintain."},
     {outcome:2,school:2,field:2,slp:26,name:"Formulating Design Briefs", description:"Introduces students to problem statements, and encourages them to ask relevant questions in order to best address a clients or projects design requirements. Defining or framing design questions well is the first step towards solving them."},
     {outcome:2,school:2,field:2,slp:27,name:"3D Design Problem Solving", description:"Design methods are investigated. Scientific methods are compared with creative and integrated methods. The study of design methods provides formal tools that equip and inform our students’ approach to design thinking and three dimensional problem solving. Students choose from a small selection of different projects - this amplifies the need for an awareness of several design strategies."},
